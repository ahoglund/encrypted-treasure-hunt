...
var ClueForm = function (_React$Component) {
  _inherits(ClueForm, _React$Component);

  function ClueForm(props) {
    _classCallCheck(this, ClueForm);

    var _this = _possibleConstructorReturn(this, (ClueForm.__proto__ || Object.getPrototypeOf(ClueForm)).call(this, props));
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'label',
            { 'for': this.props.id, className: 'sr-only' },
            'Message'
          ),
          _react2.default.createElement('textarea', { readOnly: 'true', id: this.props.id, value: this.props.message })
        ),
        _react2.default.createElement(
          'div',
          { className: 'form-group col-sm-12' },
          _react2.default.createElement('input', { type: 'text', className: 'form-control', id: 'inputKey', placeholder: 'A:B' }),
          _react2.default.createElement(
            'button',
...
var EncryptedTreasureHunt = function (_React$Component2) {
  _inherits(EncryptedTreasureHunt, _React$Component2);

  function EncryptedTreasureHunt(props) {
    _classCallCheck(this, EncryptedTreasureHunt);

    var _this2 = _possibleConstructorReturn(this, (EncryptedTreasureHunt.__proto__ || Object.getPrototypeOf(EncryptedTreasureHunt)).call(this, props));
  ...
  _createClass(EncryptedTreasureHunt, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this3 = this;

      _axios2.default.get('/hunt/' + this.props.hunt).then(function (response) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'ul',
          null,
          this.state.clues.map(function (clue) {
            return _react2.default.createElement(ClueForm, { key: clue.id, id: clue.id, message: clue.message });
          })
        )
      );
    }
  ...
  return EncryptedTreasureHunt;
}(_react2.default.Component);

_reactDom2.default.render(_react2.default.createElement(EncryptedTreasureHunt, { hunt: '1' }), document.getElementById("encrypted-treasure-hunt-app"));
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var _typeof=typeof Symbol==="function"&&typeof Symbol.iterator==="symbol"?function(obj){return typeof obj;}:function(obj){return obj&&typeof Symbol==="function"&&obj.constructor===Symbol&&obj!==Symbol.prototype?"symbol":typeof obj;};if(process.env.NODE_ENV!=="production"){(function(){'use strict';var React=__webpack_require__(5);var invariant=__webpack_require__(6);var warning=__webpack_require__(7);var ExecutionEnvironment=__webpack_require__(10);var _assign=__webpack_require__(3);var emptyFunction$1=__webpack_require__(2);var EventListener=__webpack_require__(11);var getActiveElement=__webpack_require__(12);var shallowEqual=__webpack_require__(13);var containsNode=__webpack_require__(14);var focusNode=__webpack_require__(15);var emptyObject=__webpack_require__(4);var checkPropTypes=__webpack_require__(9);var hyphenateStyleName=__webpack_require__(30);var camelizeStyleName=__webpack_require__(32);/**
 * WARNING: DO NOT manually require this module.
 * This is a replacement for `invariant(...)` used by the error code system
 * and will _only_ be required by the corresponding babel pass.
 * It always throws.
